        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#service_modal"><i class="fa fa-plus"></i> New Member</a>
                    </div>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                       ...
                                       <div class="modal-dialog modal-dialog-centered">
                                           ...
                                           <form action="backend/team.php" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="modal-footer">
                                                   ...
                                                   <button type="submit" name="edit_team_btn" class="btn btn-primary">Save</button>
                                               </div>
                                           </form>
                                           </div>
                                       </div>
                                       ...
                                       <div class="modal-dialog modal-dialog-centered">
                                           ...
                                           <form action="backend/team.php" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="modal-footer">
                                                   ...
                                                   <button type="submit" name="delete_team_btn" class="btn btn-primary">Yes</button>
                                               </div>
                                           </form>
                                           </div>
                                       </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <form action="backend/team.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" name="submit_member" class="btn btn-primary">Save</button>
                    </div>
                </form>
                </div>
            </div>
