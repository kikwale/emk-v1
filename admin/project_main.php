    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Project Main Category</h6>
                        <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#service_modal"><i class="fa fa-plus"></i> New Category</a>
                    </div>
                                       ...
                                       <div class="modal-dialog modal-dialog-centered">
                                           ...
                                           <form action="backend/project_category.php" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="modal-footer">
                                                   ...
                                                   <button type="submit" name="edit_main_project_btn" class="btn btn-primary">Update</button>
                                               </div>
                                           </form>
                                           </div>
                                       </div>
                                       ...
                                       <div class="modal-dialog modal-dialog-centered">
                                           ...
                                           <form action="backend/project_category.php" method="post" enctype="multipart/form-data">
                                               ...
                                               <div class="modal-footer">
                                                   ...
                                                   <button type="submit" name="delete_main_project_btn" class="btn btn-primary">Yes</button>
                                               </div>
                                           </form>
                                           </div>
                                       </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">New Main Project Category</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="backend/project_category.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" name="submit_main_project_category" class="btn btn-primary">Save</button>
                    </div>
                </form>
                </div>
            </div>
