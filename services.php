    ...
    <div class="site-main">
        ...
        <section class="cmt-row services-top-section clearfix">
            <div class="container">
                <div class="row">
                    <?php 
                    foreach ($services as $serviceItems => $serviceItem){;
                    ?>
                    <div class="col-lg-4 col-md-6">
                        <!--featured-imagebox-->
                        <div class="featured-imagebox-services mb-30">
                            <div class="featured-thumbnail box-shadow">
                                <img class="img-fluid" src="images/services/<?php echo $serviceItem['image']; ?>" alt="">
                            ...
                            <div class="featured-content featured-content-services box-shadow">
                                ...
                                <div class="bottom-content-services">
                                    <div class="featured-title">
                                        <h5><a href="service-details.php?service=<?php echo $serviceItems; ?>"><?php echo $serviceItem['title']; ?></a></h5>
                                    </div>
                                ...
                                <div class="services-icon-box">
                                    <a href="service-details.php?service=<?php echo $serviceItems; ?>"><i class="ti ti-plus"></i></a>
                                </div>
                            </div>
